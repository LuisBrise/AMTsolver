...
return 1. + LL(w,  0.0*eV,     0.2*eV,   113.1*eV*eV)
          + LL(w,  4.0*eV,     1.5*eV,    44.6*eV*eV)
          + LL(w,  7.3*eV,     3.3*eV,    54.8*eV*eV)
          + LL(w, 12.8*eV,    11.8*eV,   184.9*eV*eV)
          + LL(w, 18.9*eV,    71.0*eV,   728.1*eV*eV)
          + LL(w, 19.9*eV,     2.9*eV,    65.7*eV*eV)
          + LL(w, 28.9*eV,     3.9*eV,    50.0*eV*eV)
          + LL(w, 38.7*eV,    13.0*eV,    74.7*eV*eV)
          + LL(w, 64.3*eV,    51.9*eV,   544.0*eV*eV);
}
